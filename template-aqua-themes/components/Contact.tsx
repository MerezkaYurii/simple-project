...
export default function About({ contact }: ContactDataProps) {
  ...
  return (
    <section id="contact" className="px-2 sm:px-4 lg:px-6 ">
      <div className="container mx-auto  py-16 text-center bg-[#90E0EF]/20 shadow-lg dark:bg-white/5 rounded-2xl mb-[15px]">
        ...
        <a
          href={mailTo}
          className="inline-block px-6 py-2 bg-[#00B4D8] text-white rounded-xl hover:opacity-80 transition  duration-500"
        >
          {t("contact.button")}
        </a>
      </div>
