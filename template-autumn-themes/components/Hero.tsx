...
export default function Hero() {
  ...
  return (
    <section className="hero px-2 sm:px-4 lg:px-6 ">
      <div className="container  mx-auto py-16  text-center bg-[#f5d5b2]/25 dark:bg-white/5 rounded-2xl mb-[15px] shadow-md">
        <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-8">
          <div>
            ...
            <button className="px-4 py-2  bg-[#D97706] text-white rounded-xl hover:opacity-80 transition  duration-500">
              {t("hero.cta")}
            </button>
          </div>
