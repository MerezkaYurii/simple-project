...
export default function About({ contact }: ContactDataProps) {
  ...
  return (
    <section id="contact" className="px-2 sm:px-4 lg:px-6 ">
      <div className="container mx-auto  py-16 text-center bg-[#f5d5b2]/25 dark:bg-white/5 rounded-2xl mb-[15px] shadow-lg">
        ...
        <a
          href={mailTo}
          className="inline-block px-6 py-2 bg-[#D97706] text-white rounded-xl hover:opacity-80 transition  duration-500"
        >
          {t("contact.button")}
        </a>
      </div>
